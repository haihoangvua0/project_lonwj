...
def returning(n: int | float | Decimal, choice: str = "S"):
    ...
    if isinstance(n, int):
        return n
    if math.isnan(n) or math.isinf(n) or not isinstance(n, (int, float)):
        return str(n)
...
# Hàm phân tích thừa số nguyên tố cho n rất lớn (n <= 10**10)
...
if __name__ == "__main__":
    ...
    print("\n=== Debug: log & ln ===")
    for base, num in [(10, 100), (2, 8), (e, e**2), (1, 10), (10, -1)]:
        try:
